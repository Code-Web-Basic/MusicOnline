...
function DetailPlaylist() {
    ...
    return (
        <Grid2 container backgroundColor="transparent">
            <Grid2 xs={4}>
                <Stack direction="column" p={2} justifyContent="center" gap="10px" alignItems={'center'}>
                    <Box
                        sx={{ width: 300, height: 300, position: 'relative', borderRadius: '10px', overflow: 'hidden' }}
